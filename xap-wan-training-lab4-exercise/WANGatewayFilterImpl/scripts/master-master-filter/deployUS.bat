...
xcopy /E/I/F ..\..\..\ReplicationFilter\target\classes\com ..\..\deploy\wan-space-US

rem PLEASE replace 127.0.0.1 with relevant HOSTNAME in production
set GS_LOOKUP_LOCATORS=127.0.0.1:4266
call %GS_HOME%\bin\gs.bat --cli-version=1 deploy -zones US wan-space-US
call %GS_HOME%\bin\gs.bat --cli-version=1 deploy -zones US wan-gateway-US